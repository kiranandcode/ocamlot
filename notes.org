...
*** TODO Go to html and see how home is structured
*** TODO Use database to collect results (if user then users else public)
*** TODO Display posts using result from database
** TODO Setup log in page
*** TODO Pass in markdown about page in config
*** TODO vendor markdown renderer
*** TODO Create box with markdown details on login + register
** TODO refactor database to not use rec modules
