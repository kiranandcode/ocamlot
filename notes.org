...
CLOSED: [2022-03-05 Sat 16:42]
** TODO update tests to use in memory database

** TODO Setup webfinger endpoint
*** TODO look up web finger spec
*** TODO look up how pleroma responds 
** TODO Update user endpoint to return JSON response if application type is json, json+ld
** TODO Verify that actor returned has parity with pleroma  
** TODO add inbox endpoint
