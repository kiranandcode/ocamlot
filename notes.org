...
** TODO add content length field to build signed headers enforce present
** TODO validate follow request, return not acceptable if not valid
** TODO Add remote module to activitypub, parse pleroma follow request
** TODO Insert follow request into database
** TODO update code to use database outside of build dir
** TODO Look at pleroma follow object
