...
** TODO write function to validate signatures
*** TODO open join mastadon blog post on followers
*** TODO write basic function to validate functions
*** TODO read micropub.blog encoding
** TODO Write endpoint for following
** TODO Lookup how to do background tasks
