  ...
  { Operations.LocalUser.id = 2; username = "sally";
    ...
    display_name = None; about = None; manually_accepts_follows = false;
    is_admin = false; pubkey = <opaque>; privkey = <opaque> }
  $ ./app_launcher.exe test.db local-user local-user-count
  2
  ...
  $ ./app_launcher.exe test.db local-user local-user-count
  3
  $ ./app_launcher.exe test.db local-user create-user "hello" "" false true jackob bobby
  { Operations.LocalUser.id = 4; username = "jackob";
    password =
    "$argon2i$v=19$m=65536,t=3,p=2$SXnDqMKrUVvDoTLDkcSMwoDDt2DEnz/Clw$xJl5CPxVdztDAO86ek19SNGKmOnt8gPoyk/akvzd4yg";
    display_name = (Some "hello"); about = None;
    manually_accepts_follows = false; is_admin = true; pubkey = <opaque>;
    privkey = <opaque> }
  $ ./app_launcher.exe test.db local-user local-user-count  
