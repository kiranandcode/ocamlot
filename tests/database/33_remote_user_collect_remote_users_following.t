...
Tests:
  ...
  $ ./app_launcher.exe test.db remote-user collect-remote-users-following 0 100 4
  { Operations.RemoteUser.id = 3; username = "remote-joe"; instance_id = 4;
  ...
  $ ./app_launcher.exe test.db remote-user collect-remote-users-following 0 100 6
