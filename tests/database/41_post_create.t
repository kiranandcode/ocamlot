...
Arguments are [pub-id] [summary] [raw_data] [is_public] [is_follower_public] [url] [author] [post_content] [post_source] [published]

[url] is always present and uniquely identifies both local and remote posts

For local posts, [url] is a combination of the site's local domain and the posts public id

  $ ./app_launcher.exe test.db posts create "pub-id-1" "" "" true true "https://localhost/joe/posts/pub-id-1" 4 "text" "First post" "2023-01-01T10:40:39-00:00"
  ...
  $ ./app_launcher.exe test.db posts create "pub-id-2" "" "" false true "https://localhost/joe/posts/pub-id-2" 4 "markdown" "Second post" "2023-01-02T10:40:39-00:00"
  ...
  $ ./app_launcher.exe test.db posts create "pub-id-3" "" "" true false "https://localhost/joe/posts/pub-id-3" 4 "org" "Third post" "2023-01-03T10:40:39-00:00"
  ...
  $ ./app_launcher.exe test.db posts create "pub-id-4" "" "" false false "https://localhost/joe/posts/pub-id-4" 4 "text" "Fourth post" "2023-01-04T10:40:39-00:00"
...
Url's should be unique:

  $ ./app_launcher.exe test.db posts create "pub-id-5" "" "" true true "https://localhost/joe/posts/pub-id-4" 4 "text" "Fifth post" "2023-01-05T10:40:39-00:00"
  { Operations.Posts.id = 4; public_id = (Some "pub-id-4");
    url = "https://localhost/joe/posts/pub-id-4"; author_id = 4;
    is_public = false; is_follower_public = false; summary = None;
    content_type = `Text; post_source = "Fourth post";
...
Public ids should be unique, but this isn't checked:

  $ ./app_launcher.exe test.db posts create "pub-id-4" "" "" true true "https://localhost/joe/posts/pub-id-5" 4 "text" "Fifth post" "2023-01-05T10:40:39-00:00"
...
Posts by remote users have no public-id, and we track the json that created it.

  $ ./app_launcher.exe test.db posts create "" "A summary" "{\"id\": \"remote-id-1\", \"content\": \"...\"}" true true "https://fediverse.caml.uk/remote-bob/posts/remote-id-1" 1 "text" "First remote post" "2023-01-06T10:40:39-00:00"
  ...
  $ ./app_launcher.exe test.db posts create "" "A summary" "{\"id\": \"remote-id-4\", \"content\": \"...\"}" true false "https://fediverse.caml.uk/remote-bob/posts/remote-id-4" 1 "text" "Second remote post" "2023-01-09T10:40:39-00:00"
  ...
  $ ./app_launcher.exe test.db posts create "" "A second summary" "{\"id\": \"remote-id-5\", \"content\": \"...\"}" false true "https://fediverse.caml.uk/remote-bob/posts/remote-id-5" 1 "text" "Third remote post" "2023-01-10T10:40:39-00:00"
  ...
  $ ./app_launcher.exe test.db posts create "" "A third summary" "{\"id\": \"remote-id-6\", \"content\": \"...\"}" false true "https://fediverse.caml.uk/remote-bob/posts/remote-id-6" 1 "text" "Fourth remote post" "2023-01-11T10:40:39-00:00"
  ...
  $ ./app_launcher.exe test.db posts create "" "A fourth summary" "{\"id\": \"remote-id-7\", \"content\": \"...\"}" false true "https://fediverse.caml.uk/remote-bob/posts/remote-id-7" 1 "text" "Fifth remote post" "2023-01-12T10:40:39-00:00"
  ...
  $ ./app_launcher.exe test.db posts create "" "A second post" "{\"id\": \"remote-id-2\", \"content\": \"...\"}" true true "https://example.ocamlot.org/remote-sally/posts/remote-id-2" 2 "text" "Second remote post" "2023-01-07T10:40:39-00:00"
  ...
  $ ./app_launcher.exe test.db posts create "" "A third post" "{\"id\": \"remote-id-3\", \"content\": \"...\"}" true true "https://example.ocamlot.org/remote-sally/posts/remote-id-3" 2 "text" "Third remote post" "2023-01-08T10:40:39-00:00"
  ...
  $ ./app_launcher.exe test.db posts create "" "A fourth post" "{\"id\": \"remote-id-4\", \"content\": \"...\"}" true true "https://example.ocamlot.org/remote-sally/posts/remote-id-4" 2 "text" "Fourth remote post" "2023-01-09T10:40:39-00:00"
  ...
  $ ./app_launcher.exe test.db posts create "" "A fifth post" "{\"id\": \"remote-id-5\", \"content\": \"...\"}" true true "https://example.ocamlot.org/remote-sally/posts/remote-id-5" 2 "text" "Fifth remote post" "2023-01-10T10:40:39-00:00"
  ...
  $ ./app_launcher.exe test.db posts create "" "A third post" "{\"id\": \"remote-id-3\", \"content\": \"...\"}" true true "https://random.comp.fedi.sg/remote-joe/posts/remote-id-3" 3 "text" "Third remote post" "2023-01-08T10:40:39-00:00"
  ...
  $ ./app_launcher.exe test.db posts create "" "A fourth post" "{\"id\": \"remote-id-4\", \"content\": \"...\"}" true true "https://random.comp.fedi.sg/remote-joe/posts/remote-id-4" 3 "text" "Fourth remote post" "2023-01-09T10:40:39-00:00"
  ...
  $ ./app_launcher.exe test.db posts create "" "A fifth post" "{\"id\": \"remote-id-5\", \"content\": \"...\"}" true true "https://random.comp.fedi.sg/remote-joe/posts/remote-id-5" 3 "text" "Fifth remote post" "2023-01-10T10:40:39-00:00"  
  ...
  $ ./app_launcher.exe test.db posts lookup-by-public-id pub-id-1
  { Operations.Posts.id = 1; public_id = (Some "pub-id-1");
    url = "https://localhost/joe/posts/pub-id-1"; author_id = 4;
    is_public = true; is_follower_public = true; summary = None;
    content_type = `Text; post_source = "First post";
  ...
  $ ./app_launcher.exe test.db posts lookup-by-public-id pub-id-100
  None
