...
Setup remote users:
  ...
  $ ./app_launcher.exe test.db remote-user lookup-remote-user-by-url "https://fediverse.caml.uk/remote-bob"
  ...
  $ ./app_launcher.exe test.db remote-user lookup-remote-user-by-url "https://random.comp.fedi.sg/remote-bob"
  ...
  $ ./app_launcher.exe test.db remote-user lookup-remote-user-by-url "https://example.ocamlot.org/remote-bob"
  None
