...
Lookup local users:
  ...
  $ ./app_launcher.exe test.db actor lookup-local-user 1
  5

  $ ./app_launcher.exe test.db actor lookup-local-user 2
  6

  $ ./app_launcher.exe test.db actor lookup-local-user 3
  7

  $ ./app_launcher.exe test.db actor lookup-local-user 4
  8
