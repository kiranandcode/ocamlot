...
Create local user:
  ...
  $ ./app_launcher.exe test.db actor create-local-user 1
  1

  $  ./app_launcher.exe test.db actor resolve 1
  local 1

  $ ./app_launcher.exe test.db actor create-local-user 2
  2

  $  ./app_launcher.exe test.db actor resolve 2
  local 2
