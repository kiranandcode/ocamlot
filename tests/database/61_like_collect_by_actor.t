...
Setup likes:
  ...
  $ ./app_launcher.exe test.db likes create like-0 "" "https://localhost/likes/like-0" 1 4 "2023-01-14T10:40:39-00:00" > ignore
  $ ./app_launcher.exe test.db likes create like-1 "" "https://localhost/likes/like-1" 1 6 "2023-01-14T10:40:39-00:00" > ignore
  $ ./app_launcher.exe test.db likes create like-2 "" "https://localhost/likes/like-2" 1 7 "2023-01-14T10:40:39-00:00" > ignore
  $ ./app_launcher.exe test.db likes create like-3 "" "https://example.ocamlot.org/likes/like-3" 1 2 "2023-01-14T10:40:39-00:00" > ignore
  $ ./app_launcher.exe test.db likes create like-4 "" "https://example.ocamlot.org/likes/like-4" 2 2 "2023-01-14T10:40:39-00:00" > ignore
  $ ./app_launcher.exe test.db likes create like-5 "" "https://example.ocamlot.org/likes/like-5" 3 2 "2023-01-14T10:40:39-00:00" > ignore
  $ ./app_launcher.exe test.db likes create like-6 "" "https://localhost/likes/like-6" 3 7 "2023-01-14T10:40:39-00:00" > ignore
  $ ./app_launcher.exe test.db likes create like-7 "" "https://localhost/likes/like-7" 4 7 "2023-01-14T10:40:39-00:00" > ignore

Tests:

  $ ./app_launcher.exe test.db likes collect-by-actor 0 100 1

  $ ./app_launcher.exe test.db likes collect-by-actor 0 100 2
  ...
  $ ./app_launcher.exe test.db likes collect-by-actor 0 100 3

  $ ./app_launcher.exe test.db likes collect-by-actor 0 100 4
  ...
  $ ./app_launcher.exe test.db likes collect-by-actor 0 100 5

  $ ./app_launcher.exe test.db likes collect-by-actor 0 100 6
  ...
  $ ./app_launcher.exe test.db likes collect-by-actor 0 100 7
  ...
  $ ./app_launcher.exe test.db likes collect-by-actor 0 100 8
