...
Tests:
  ...
  $ ./app_launcher.exe test.db posts count-direct 1
  2

  $ ./app_launcher.exe test.db posts count-direct 2
  1

  $ ./app_launcher.exe test.db posts count-direct 3
  0

  $ ./app_launcher.exe test.db posts count-direct 4
  1

  $ ./app_launcher.exe test.db posts count-direct 5
  0

  $ ./app_launcher.exe test.db posts collect-direct 0 100 "2023-01-29T10:40:39-00:00" 1
  ...
  $ ./app_launcher.exe test.db posts collect-direct 0 100 "2023-01-29T10:40:39-00:00" 2
  { Operations.Posts.id = 1; public_id = (Some "pub-id-1");
    url = "https://localhost/joe/posts/pub-id-1"; author_id = 4;
    is_public = true; is_follower_public = true; summary = None;
    content_type = `Text; post_source = "First post";
  ...
  $ ./app_launcher.exe test.db posts collect-direct 0 100 "2023-01-29T10:40:39-00:00" 3

  $ ./app_launcher.exe test.db posts collect-direct 0 100 "2023-01-29T10:40:39-00:00" 4
  { Operations.Posts.id = 2; public_id = (Some "pub-id-2");
    url = "https://localhost/joe/posts/pub-id-2"; author_id = 4;
    is_public = false; is_follower_public = true; summary = None;
    content_type = `Markdown; post_source = "Second post";
  ...
  $ ./app_launcher.exe test.db posts collect-direct 0 100 "2023-01-29T10:40:39-00:00" 5
