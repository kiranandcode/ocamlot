...
Tests:
  ...
  $ ./app_launcher.exe test.db posts add-post-mention 1 2

  $ ./app_launcher.exe test.db posts add-post-mention 1 3

  $ ./app_launcher.exe test.db posts add-post-mention 1 1

  $ ./app_launcher.exe test.db posts add-post-mention 2 4

  $ ./app_launcher.exe test.db posts post-to 0 100 1

  $ ./app_launcher.exe test.db posts post-cc 0 100 1

  $ ./app_launcher.exe test.db posts post-mentions 0 100 1
  1
  2
  3

  $ ./app_launcher.exe test.db posts post-to 0 100 2
  $ ./app_launcher.exe test.db posts post-cc 0 100 2
  $ ./app_launcher.exe test.db posts post-mentions 0 100 2
  4
