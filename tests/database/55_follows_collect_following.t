...
Tests:
  ...
  $ ./app_launcher.exe test.db follows count-following 4
  3

  $ ./app_launcher.exe test.db follows collect-following-for-actor 0 100 "2023-01-29T10:40:39-00:00" 4
  { Operations.Follows.id = 6; public_id = (Some "follow-id-6");
    url = "https://localhost/joe/follow/follow-id-6"; raw_data = None;
    pending = false; created = 2023-01-13 10:40:39 +00:00; updated = None;
    author_id = 4; target_id = 3 }
  ...
  { Operations.Follows.id = 5; public_id = (Some "follow-id-5");
    url = "https://localhost/joe/follow/follow-id-5"; raw_data = None;
    pending = false; created = 2023-01-12 10:40:39 +00:00; updated = None;
    author_id = 4; target_id = 2 }
