...
Tests:
  ...
  $ ./app_launcher.exe test.db posts add-post-tag 1 "awesom"

  $ ./app_launcher.exe test.db posts add-post-tag 1 "2020"

  $ ./app_launcher.exe test.db posts add-post-tag 1 "2021"

  $ ./app_launcher.exe test.db posts add-post-tag 1 "epic"

  $ ./app_launcher.exe test.db posts add-post-tag 1 "awesom"

  $ ./app_launcher.exe test.db posts add-post-tag 1 "awesom"

  $ ./app_launcher.exe test.db posts add-post-tag 2 "epic"

  $ ./app_launcher.exe test.db posts add-post-tag 2 "epic"

  $ ./app_launcher.exe test.db posts add-post-tags 1 "awesom,2020,2021"

  $ ./app_launcher.exe test.db posts post-tags 0 100 1
  awesom
  2020
  2021
  epic

  $ ./app_launcher.exe test.db posts post-tags 0 100 2
  epic
