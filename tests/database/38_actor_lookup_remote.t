...
Lookup remote users:
  ...
  $ ./app_launcher.exe test.db actor lookup-remote-user 1
  1

  $ ./app_launcher.exe test.db actor lookup-remote-user 2
  2

  $ ./app_launcher.exe test.db actor lookup-remote-user 3
  3

  $ ./app_launcher.exe test.db actor lookup-remote-user 4
  5
