...
Tests:
  ...
  $ ./app_launcher.exe test.db follows create "follow-id-0" "" "" "https://localhost/joe/follow/follow-id-0" 4 6 true "2023-01-11T10:40:39-00:00"
  { Operations.Follows.id = 1; public_id = (Some "follow-id-0");
    url = "https://localhost/joe/follow/follow-id-0"; raw_data = None;
    pending = true; created = 2023-01-11 10:40:39 +00:00; updated = None;
    author_id = 4; target_id = 6 }

  $ ./app_launcher.exe test.db follows create "follow-id-2" "" "" "https://localhost/joe/follow/follow-id-2" 6 1 true "2023-01-12T10:40:39-00:00"
  { Operations.Follows.id = 2; public_id = (Some "follow-id-2");
    url = "https://localhost/joe/follow/follow-id-2"; raw_data = None;
    pending = true; created = 2023-01-12 10:40:39 +00:00; updated = None;
    author_id = 6; target_id = 1 }

  $ ./app_launcher.exe test.db follows create "follow-id-3" "" "" "https://localhost/joe/follow/follow-id-3" 4 7 false "2023-01-12T10:40:39-00:00"
  { Operations.Follows.id = 3; public_id = (Some "follow-id-3");
    url = "https://localhost/joe/follow/follow-id-3"; raw_data = None;
    pending = false; created = 2023-01-12 10:40:39 +00:00; updated = None;
    author_id = 4; target_id = 7 }

  $ ./app_launcher.exe test.db follows find-follow-between 4 7
  { Operations.Follows.id = 3; public_id = (Some "follow-id-3");
    url = "https://localhost/joe/follow/follow-id-3"; raw_data = None;
    pending = false; created = 2023-01-12 10:40:39 +00:00; updated = None;
    author_id = 4; target_id = 7 }

  $ ./app_launcher.exe test.db follows find-follow-between 6 1
  { Operations.Follows.id = 2; public_id = (Some "follow-id-2");
    url = "https://localhost/joe/follow/follow-id-2"; raw_data = None;
    pending = true; created = 2023-01-12 10:40:39 +00:00; updated = None;
    author_id = 6; target_id = 1 }

  $ ./app_launcher.exe test.db follows is-following 4 7
  true

  $ ./app_launcher.exe test.db follows is-following 7 4
  false

  $ ./app_launcher.exe test.db follows is-following 6 1
  false

  $ ./app_launcher.exe test.db follows is-following 1 6
  false

  $ ./app_launcher.exe test.db follows resolve 2
  { Operations.Follows.id = 2; public_id = (Some "follow-id-2");
    url = "https://localhost/joe/follow/follow-id-2"; raw_data = None;
    pending = true; created = 2023-01-12 10:40:39 +00:00; updated = None;
    author_id = 6; target_id = 1 }

  $ ./app_launcher.exe test.db follows lookup-by-public-id follow-id-2
  { Operations.Follows.id = 2; public_id = (Some "follow-id-2");
    url = "https://localhost/joe/follow/follow-id-2"; raw_data = None;
    pending = true; created = 2023-01-12 10:40:39 +00:00; updated = None;
    author_id = 6; target_id = 1 }

  $ ./app_launcher.exe test.db follows lookup-by-url "https://localhost/joe/follow/follow-id-3"
  { Operations.Follows.id = 3; public_id = (Some "follow-id-3");
    url = "https://localhost/joe/follow/follow-id-3"; raw_data = None;
    pending = false; created = 2023-01-12 10:40:39 +00:00; updated = None;
    author_id = 4; target_id = 7 }
