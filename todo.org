...
*** TODO Add field to table to track inreply to
*** TODO Add table to track context relationships
*** TODO On click on post, show all posts with same context
*** TODO When adding post, add post to all posts
